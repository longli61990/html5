(function($)
{
    $.fn.ggk = function(option, settings)
    {
        ...
        else if(typeof option == 'string')
        {
            ...
            var elements = this.each(function()
            {
                ...
                if(data)
                {
                    ...
                    else if($.fn.ggk.defaultSettings[option] !== undefined)
                    {
        ...
        settings = $.extend({}, $.fn.ggk.defaultSettings, settings || {});
    ...
    $.fn.ggk.defaultSettings =
    {
        width		: 268,						// set width - best to match image width
        height		: 52,						// set height - best to match image height
        image		: null,		// set image path
        image2		: 'img/kgqy.png',						// set overlay image path - if set color is not used
        color		: '#ACAA9C',				// set scratch color - if image2 is not set uses color
    ...
    ScratchPad.prototype =
    {
        ...
        drawImage: function(imagePath)
        {
            ...
            img.src = imagePath;
            $(img).load(function(){
                $this.ctx.drawImage(img,0,0,img.width,img.height,0,0,$this.settings.width,$this.settings.height);
                $this.setBgImage();
            })
        },
